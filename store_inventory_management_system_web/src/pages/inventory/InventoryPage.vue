  ...
  <el-dialog v-model="editVisible" title="编辑库存商品信息" width="500px">
    <el-form :model="editForm" label-width="100px">
      ...
      <el-form-item label="出售单价">
        <el-input-number v-model="editForm.productPrice" :precision="2" :step="0.1" :min="0" style="width: 100%" />
      </el-form-item>
      <el-form-item label="预警阈值">
        <el-input-number v-model="editForm.warningThreshold" :min="0" style="width: 100%" />
      </el-form-item>
    </el-form>
    <template #footer>
