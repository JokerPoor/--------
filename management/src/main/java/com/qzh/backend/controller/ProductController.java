...
public class ProductController {
     ...
     */
    @PostMapping
    @AuthCheck(interfaceName = PRODUCT_ADD_POST)
     ...
     */
    @PutMapping
    @AuthCheck(interfaceName = PRODUCT_UPDATE_PUT)
     ...
     */
    @DeleteMapping("/{id}")
    @AuthCheck(interfaceName = PRODUCT_DELETE_DELETE)
     ...
     */
    @GetMapping("/{id}")
    @AuthCheck(interfaceName = PRODUCT_DETAIL_GET)
     ...
     */
    @GetMapping("/list")
    @AuthCheck(interfaceName = PRODUCT_LIST_GET)
     ...
     */
    @GetMapping("/list/own")
    @AuthCheck(interfaceName = PRODUCT_LIST_OWN_GET)
